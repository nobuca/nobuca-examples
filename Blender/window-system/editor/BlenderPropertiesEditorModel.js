...
export default class BlenderPropertiesEditorModel extends BlenderEditorModel {
    ...
    createTabTool() {
        ...
        var headerImage = new NobucaImageModel("./window-system/icons/toolbar-icon-tweak.png");
    ...
    createTabToolSectionWorkspace() {
        ...
        objectMode.setImageSrc("./window-system/icons/icon-mode-object.svg");
    ...
    createTabRender() {
        ...
        var headerImage = new NobucaImageModel("./window-system/icons/icon-data-block-scene.svg");
