...
export default class BlenderTimelineEditorModel extends BlenderEditorModel {
    ...
    createRegionHeaderAutoKeying() {
        ...
        control.setEnabledImageSrc("./window-system/icons/icon-auto-keying.svg");
        control.setDisabledImageSrc("./window-system/icons/icon-auto-keying.svg");
    ...
    createRegionHeaderTransportControls() {
        ...
        buttons.addItem(new NobucaButtonBarItemModel("./window-system/icons/icon-jump-to-start.svg"));
        buttons.addItem(new NobucaButtonBarItemModel("./window-system/icons/icon-jump-to-previous-keyframe.svg"));
        buttons.addItem(new NobucaButtonBarItemModel("./window-system/icons/icon-rewind.svg"));
        buttons.addItem(new NobucaButtonBarItemModel("./window-system/icons/icon-play.svg"));
        buttons.addItem(new NobucaButtonBarItemModel("./window-system/icons/icon-jump-to-next-keyframe.svg"));
        buttons.addItem(new NobucaButtonBarItemModel("./window-system/icons/icon-jump-to-end.svg"));
    }
    ...
    createRegionHeaderCurrentFrame() {
        ...
        bar.addItem(new BlenderControlButtonModel("./window-system/icons/icon-cronometer.svg"));
