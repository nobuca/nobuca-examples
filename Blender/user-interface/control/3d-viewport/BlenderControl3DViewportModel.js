...
export default class BlenderControl3DViewportModel extends NobucaComponentModel {
    ...
    createGeometryTriangles() {
        ...
        triangle1.getColor().setRedGreenBlue(.75, .75, .75, 1);
        ...
        triangle2.getColor().setRedGreenBlue(.75, .75, .75, 1);
        ...
        triangle3.getColor().setRedGreenBlue(.65, .65, .65, 1);
        ...
        triangle4.getColor().setRedGreenBlue(.65, .65, .65, 1);
        ...
        triangle5.getColor().setRedGreenBlue(.55, .55, .55, 1);
        ...
        triangle6.getColor().setRedGreenBlue(.55, .55, .55, 1);
        ...
        triangle7.getColor().setRedGreenBlue(.45, .45, .45, 1);
        ...
        triangle8.getColor().setRedGreenBlue(.45, .45, .45, 1);
        ...
        triangle9.getColor().setRedGreenBlue(.35, .35, .35, 1);
        ...
        triangle10.getColor().setRedGreenBlue(.35, .35, .35, 1);
        ...
        triangle11.getColor().setRedGreenBlue(.85, .85, .85, 1);
        ...
        triangle12.getColor().setRedGreenBlue(.85, .85, .85, 1);
